...
public class CameraActivity extends Activity {
    ...
    public static final String CONTENT_TYPE_CARID = "carId";
    ...
    private void initParams() {
        ...
        switch (contentType) {
            ...
            case CONTENT_TYPE_PASSPORT:
                ...
                overlayView.setVisibility(View.INVISIBLE);
                break;
                case CONTENT_TYPE_CARID:
                    maskType=MaskView.MASK_TYPE_CARID;
                      overlayView.setVisibility(View.INVISIBLE);
                    break;
...
//                    else if (cropMaskView.getMaskType() == MaskView.MASK_TYPE_CARID) {
//                        cropView.setFilePath(outputFile.getAbsolutePath());
//                        cropMaskView.setVisibility(View.INVISIBLE);
//                        overlayView.setVisibility(View.VISIBLE);
//                        overlayView.setTypeWide();
