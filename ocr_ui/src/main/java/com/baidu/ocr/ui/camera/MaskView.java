...
public class MaskView extends View {
    ...
    public static final int MASK_TYPE_CARID = 202;
    public static final int MASK_TYPE_VIN = 203;

    @IntDef({MASK_TYPE_NONE, MASK_TYPE_ID_CARD_FRONT, MASK_TYPE_ID_CARD_BACK, MASK_TYPE_BANK_CARD,
            MASK_TYPE_PASSPORT,MASK_TYPE_CARID,MASK_TYPE_VIN})
    @interface MaskType {
    ...
    private int maskColor = Color.argb(255, 0, 0, 0);
